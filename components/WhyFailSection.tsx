...
export default function WhyFailSection() {
  ...
  return (
    <section className="py-24 md:py-32 bg-[#0F172A] text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#FF5E00]/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          <div className="lg:col-span-5">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-4xl sm:text-5xl font-black leading-[1.1] mb-8">
                কেন ২০২৬-এ <br />
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/10">
                  <div className="w-12 h-12 rounded-xl bg-[#FF5E00]/20 flex items-center justify-center">
                    <TrendingDown className="w-6 h-6 text-[#FF5E00]" />
                  </div>
                  <div>
                    <div className="text-sm font-bold text-gray-400 uppercase tracking-wider">গড় অর্গানিক রিচ</div>
                    <div className="text-2xl font-black text-white">~১.৬৫%</div>
                  </div>
                </div>
              </div>
            </motion.div>
          ...
          <div className="lg:col-span-7 space-y-4">
            {stats.map((item, idx) => (
              <motion.div
                ...
                className="group bg-white/5 hover:bg-white/10 border border-white/10 p-6 sm:p-8 rounded-[32px] transition-all duration-300"
              >
                <div className="flex flex-col sm:flex-row gap-6 items-start">
                  <div className={`w-14 h-14 rounded-2xl ${item.color}/10 flex items-center justify-center shrink-0 border border-white/10`}>
