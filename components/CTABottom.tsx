...
export default function CTABottom() {
  return (
    <div className="relative py-20 md:py-32 overflow-hidden border-t border-gray-100 bg-white">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] md:w-[80%] h-[80%] bg-[#FFCE0B]/10 blur-[100px] md:blur-[150px] rounded-full pointer-events-none"></div>
      ...
      <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 relative z-10">
        <h2 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight text-[#0F172A] mb-4 sm:mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FFCE0B] to-[#FF9D00]">সফলতার যাত্রা</span>
        </h2>
        ...
        <button 
          ...
          className="group relative w-full sm:w-auto inline-flex items-center justify-center px-8 sm:px-10 py-4 sm:py-5 text-base sm:text-lg font-bold text-[#0F172A] transition-all duration-300 bg-[#FFCE0B] rounded-2xl sm:rounded-full hover:scale-[1.02] active:scale-95 shadow-xl shadow-[#FFCE0B]/20 hover:shadow-2xl hover:shadow-[#FFCE0B]/30 hover:bg-[#D4A809] overflow-hidden"
        >
